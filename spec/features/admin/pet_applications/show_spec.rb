...
RSpec.describe 'admin application index page' do
  before(:each) do
    @app1 = PetApplication.create!(name: 'Liam', street: '155 Main Street', city: 'Phoenix', state: 'AZ', zip: 85_222, status: 1)
    ...
    PetApplicationPet.create!(pet_application: @app1, pet: @pet3)
